...
namespace FinalProject.Controllers
{
    ...
    public class CelebritiesController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public ActionResult<Celebrity>  Get(string id)
        {
            if (Char.IsDigit(id[0]))
            {
                Celebrity c = _Db.celebrities.ToList().Find(ce => ce.id == int.Parse(id));
            ...
            {
                Celebrity c = _Db.celebrities.ToList().Find(ce => ce.Name.ToLower().Contains(id.ToLower()));
        ...
        //// GET api/<CelebritiesController>/5
        //[HttpGet("{Name}")]
        //public ActionResult<Celebrity> Get(string Name)
        //{
        //    Celebrity c = _Db.celebrities.ToList().Find(ce => ce.Name.Contains(Name));
        ...
        public ActionResult<String> Put(int id, [FromBody] Celebrity celebrity)
        {
            ...
            if (c != null)
            {
                ...
                c.price = celebrity.price;
                c.BriefDescription = celebrity.BriefDescription;
